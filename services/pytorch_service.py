import argparse
from opennlu.services.pytorch_JointBERT.trainer import Trainer
from opennlu.services.pytorch_JointBERT.utils import init_logger, load_tokenizer, read_prediction_text, MODEL_PATH_MAP, MODEL_CLASSES
from opennlu.services.pytorch_JointBERT.data_loader import load_and_cache_examples
import os
...
class PT(object):
    def __init__(self, name, model_type, batch_size, learning_rate, num_train_epochs, max_seq_len, use_crf):
        ...
        self.args.data_dir = os.path.join(os.getcwd(),'opennlu/services/pytorch_JointBERT/cached_data') #input data directory
